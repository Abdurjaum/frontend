  ...
  render(){    
    ...
    <header class="app-header">
      ...
      <nav class="app-top-nav">
        <a href="/welcomepage" @click="${anchorRoute}">Home</a>  
    ...
    <sl-drawer class="app-side-menu" placement="left">
      ...
      <nav class="app-side-menu-items">
        <a href="/therapists" @click="${this.menuClick}">Find a therapist</a>
        <a href="/mytrack" @click="${this.menuClick}">My Track</a>
        <a href="/exploretracks" @click="${this.menuClick}">Explore Tracks</a>
        <a href="/schedule" @click="${this.menuClick}">Schedule</a>
