...
class Auth {
  ...
  async signUp(userData) {
    ...
    /// sign up success - show toast and redirect to question 1
    _Toast.default.show('Account created');
    // redirect to question 1
    (0, _Router.gotoRoute)('/question1');
  }
  async signIn(userData) {
    ...
    if (data.user.newUser == true) {
      ...
      (0, _Router.gotoRoute)('/welcomepage');
    }
  }
  async check(success) {
...
},{"@popperjs/core":"../node_modules/@popperjs/core/lib/index.js"}],"views/pages/guide.js":[function(require,module,exports) {
"use strict";
...
class Therapists6View {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Therapists\" user=\"", "\"></va-app-header>\n      <div class=\"page-content calign\">        \n        <br><h1 class=\"heading\">Therapist</h1><br>\n\n      \n        <sl-input placeholder=\"Find a therapist\" size=\"medium\">\n        <sl-icon name=\"search\" slot=\"prefix\"></sl-icon>\n        </sl-input><br></br><br>\n\n        <div class=\"row\">\n              <div class=\"column2\" style=\"background-color:#f08b58;\">\n\n                <div class=\"txt-th\">\n                <h1 style=\"color:#fff\" >Our best therapist for you</h1>\n\n              </div>\n              </div>\n\n              <div class=\"column\" style=\"background-color:#97bbf9;\">\n\n                <div class=\"dc\">\n                </div>\n              \n                <br><h4 style=\"color:#fff\">Mark Harel</h4>\n                <p style=\"color:#fff\">Couple therapist</p><br><br>\n\n                <div class=\"rating-dc\">\n                <sl-rating label=\"Rating\" precision=\"0.5\" readonly value=\"4.0\"></sl-rating>\n                </div>\n\n                <div class=\"read-dc\">\n                <p style=\"color:#28443c\" @click=", ">More info</p>\n                </div>\n\n              </div>\n\n              <div class=\"column\" style=\"background-color:#97bbf9;\">\n\n                <div class=\"dc1\">\n                </div>\n              \n                <br><h4 style=\"color:#fff\">Jessica West</h4>\n                <p style=\"color:#fff\">Anger management therapist</p><br><br>\n\n                <div class=\"rating-dc\">\n                <sl-rating label=\"Rating\" precision=\"0.5\" readonly value=\"4.5\"></sl-rating>\n                </div>\n\n                <div class=\"read-dc\">\n                <p style=\"color:#28443c\">More info</p>\n                </div>\n\n              </div>\n\n              <div class=\"column\" style=\"background-color:#97bbf9;\">\n\n                <div class=\"dc2\">\n                </div>\n              \n                <br><h4 style=\"color:#fff\">Monica Everline</h4>\n                <p style=\"color:#fff\">Stress management therapist</p><br><br>\n\n                <div class=\"rating-dc\">\n                  <sl-rating label=\"Rating\" precision=\"0.5\" readonly value=\"4.5\"></sl-rating>\n                </div>\n\n                <div class=\"read-dc\">\n                  <p style=\"color:#28443c\">More info</p>\n                </div>\n\n              </div>\n            </div>\n\n\n            <div class=\"end3\">\n\n        <div class=\"text-3\">\n\n        <div class=\"bigx\">\n        <sl-icon-button name=\"x\" label=\"x\" style=\"font-size: 2.5rem;\" @click=", " ></sl-icon-button>\n        </div>\n\n        <h4 style=\"color:white\">YOU'RE ALL SET</h4>\n        <br><h4 style=\"color:white\">BOOKING IS DONE</h4>\n        <br></br><h4 style=\"color:#ee570c\">Check your schedule for any</h4>\n        <h4 style=\"color:#ee570c\">updates or changes</h4>\n\n        </div>\n        \n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/therapists2'), () => (0, _Router.gotoRoute)('/therapists'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new Therapists6View();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/mytrack.js":[function(require,module,exports) {
"use strict";
...
class scheduleView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Schedule\" user=\"", "\"></va-app-header>\n      <div class=\"page-content calign\">   \n\n        <br><h1 class=\"heading\">Schedule</h1><br>\n\n        <div class=\"clearfix\">\n\n          <div class=\"box1\" style=\"background-color:#97bbf9\">\n\n            <div class=\"ld6\">\n            </div>\n\n            <div class=\"txt5\">\n            <h4 style=\"color:#fff\">Mark Harel</h4>\n            <p style=\"color:#fff\">Couple therapist</p>\n            <div class=\"rating\">\n            <sl-rating label=\"Rating\" precision=\"0.5\" readonly value=\"4.0\"></sl-rating>\n            </div>\n            </div>\n\n            <div class=\"read2\">\n                <p style=\"color:#456b60;font-weight:400\" @click=", ">View appointment</p>\n                </div>\n\n          </div>\n          \n          <div class=\"box1\" style=\"background-color:#97bbf9\">\n\n            <div class=\"ld7\">\n            </div>\n\n            <div class=\"txt5\">\n            <h4 style=\"color:#fff\">Jessica West</h4>\n            <p style=\"color:#fff\">Anger management therapist</p>\n            <div class=\"rating\">\n            <sl-rating label=\"Rating\" precision=\"0.5\" readonly value=\"4.5\"></sl-rating>\n            </div>\n            </div>\n\n            <div class=\"read2\">\n                <p style=\"color:#456b60;font-weight:400\">View appointment</p>\n                </div>\n\n          </div>\n\n        </div>\n\n        <div class=\"clearfix\">\n          <div class=\"box1\" style=\"background-color:#eaf2ff\">\n          </div>\n\n          <div class=\"box1\" style=\"background-color:#eaf2ff\">\n          </div>\n        </div>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/schedule2'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new scheduleView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/question1.js":[function(require,module,exports) {
"use strict";
...
class question2View {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <div class=\"quest calign\">\n\n    <br></br><h1 class=\"heading\">BetterDays</h1><br>\n\n    <div class=\"progress\" style=\"height: 10px;\">\n    <div class=\"progress-bar\" role=\"progressbar\" style=\"width: 40%;\" aria-valuenow=\"40\" aria-valuemin=\"0\" aria-valuemax=\"100\"></div>\n    </div><br><br>\n\n      <div class=\"question\">\n\n        <div class=\"qt\">\n\n        <br><h4>In the past two weeks, how often have you felt down, depressed or hopeless ?</h4><br><br>\n        <sl-radio-group>\n        <sl-radio value=\"1\">Not at all</sl-radio><br></br><br>\n        <sl-radio value=\"2\">Several days</sl-radio><br></br><br>\n        <sl-radio value=\"3\">More than a week</sl-radio><br></br><br>\n        <sl-radio value=\"4\">Everyday</sl-radio><br></br><br>\n        </sl-radio-group></div>\n\n        \n      </div>\n\n      <br></br><sl-button @click=", ">Previous question</sl-button>\n      <sl-button type=\"primary\" @click=", ">Next question</sl-button>\n      </div>\n    "])), () => (0, _Router.gotoRoute)('/question1'), () => (0, _Router.gotoRoute)('/question3'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new question2View();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/question3.js":[function(require,module,exports) {
"use strict";
...
class question5View {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <div class=\"quest calign\">\n\n    <br></br><h1 class=\"heading\">BetterDays</h1><br>\n\n    <div class=\"progress\" style=\"height: 10px;\">\n    <div class=\"progress-bar\" role=\"progressbar\" style=\"width: 100%;\" aria-valuenow=\"100\" aria-valuemin=\"0\" aria-valuemax=\"100\"></div>\n    </div><br><br>\n\n      <div class=\"question\">\n\n        <div class=\"qt\">\n\n        <br><h4>Have you ever been to a therapy session ?</h4><br><br>\n        <sl-radio-group>\n        <sl-radio value=\"1\">No, never</sl-radio><br></br><br>\n        <sl-radio value=\"2\">No, but i'd like to</sl-radio><br></br><br>\n        <sl-radio value=\"3\">Yes, i've been to</sl-radio><br></br><br>\n        <sl-radio value=\"4\">Yes, that's my escape !</sl-radio><br></br><br>\n        </sl-radio-group></div>\n\n        \n      </div>\n\n      <br></br><sl-button @click=", ">Previous question</sl-button>\n      <sl-button type=\"primary\" @click=", ">Sign In</sl-button>\n      </div>\n    "])), () => (0, _Router.gotoRoute)('/question4'), () => (0, _Router.gotoRoute)('/signin'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new question5View();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/welcomepage.js":[function(require,module,exports) {
"use strict";
...
class exploreView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n    <va-app-header title=\"Home\" user=", "></va-app-header>\n      \n    <div class=\"page-content\">\n\n        <div class=\"Speciality\">\n\n          <section class=\"review\" id=\"review\">\n\n            <br><br><h1 class=\"heading1\" >Explore</h1>\n            <h1 class=\"heading2\">Thank you for choosing us</h1><br><br>\n            <p class=\"p1\">Making proffessional theraphy accessible, affordable</p>\n            <p class=\"p1\">and convenient. So anyone who struggles with life's challenges </p>\n            <p class=\"p1\">can get help anytime and anywhere.</p><br></br><br>\n\n            \n            <div class=\"row\">\n              <div class=\"column\">\n              <div class=\"square\">\n\n                <div class=\"txt\"><br><br><br><br><br><br><br>\n                <br><br><br><br><br><br><br><br><h2 style=\"color:#fff\" >Our best features for you</h2>\n\n              </div>\n              </div>\n              </div>\n\n              <div class=\"column\" style=\"background-color:#97bbf9;\">\n                <h3 style=\"color:#fff\">Cope with stress</h3><br>\n                <p style=\"color:#fff\">sed quia non numquam eius a incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>\n\n                <div class=\"read\">\n                <p @click=", ">Read more</p>\n                </div>\n\n              </div>\n\n              <div class=\"column\" style=\"background-color:#97bbf9;\">\n                <h3 style=\"color:#fff\">Depression</h3><br>\n                <p style=\"color:#fff\">sed quia non numquam eius a incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>\n\n                <div class=\"read\">\n                <p>Read more</p>\n                </div>\n\n              </div>\n\n              <div class=\"column\" style=\"background-color:#97bbf9;\">\n                <h3 style=\"color:#fff\">Build on Self confidence</h3><br>\n                <p style=\"color:#fff\">sed quia non numquam eius a incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>\n\n                <div class=\"read1\">\n                <p>Read more</p>\n                </div>\n\n              </div>\n            </div>\n\n          \n          </section>\n        </div>\n\n        <div class=\"ft\"></div>\n\n    </div>\n     \n    "])), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/exploretracks2'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new exploreView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/exploretracks2.js":[function(require,module,exports) {
"use strict";
...
class mytrack3View {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"My Track\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">    \n        \n        <br><h1 class=\"heading\">My Track</h1>\n\n        <div class=\"four\">\n            \n            <div class=\"myt\">\n\n            <div class=\"icon-button-color\">\n            <sl-icon-button name=\"x\" label=\"x\" style=\"font-size: 2.5rem;\" @click=", " ></sl-icon-button>\n            </div>\n\n        </div>\n\n        <div class=\"ld5\">\n        </div>\n        \n              <div class=\"myt1\">           \n              <br><h1 class=\"my1\">Well Done</h1>\n\n              <h5 style=\"color:white\">We wish this exercise was a help for you !</h5>\n              </div>\n\n            </div>\n\n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/mytrack4'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new mytrack3View();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/mytrack4.js":[function(require,module,exports) {
"use strict";
...
var _default = new mytrack4View();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/schedule2.js":[function(require,module,exports) {
"use strict";
...
var _therapists = _interopRequireDefault(require("./views/pages/therapists"));
var _therapists2 = _interopRequireDefault(require("./views/pages/therapists2"));
var _therapists3 = _interopRequireDefault(require("./views/pages/therapists3"));
var _therapists4 = _interopRequireDefault(require("./views/pages/therapists4"));
var _therapists5 = _interopRequireDefault(require("./views/pages/therapists5"));
var _therapists6 = _interopRequireDefault(require("./views/pages/therapists6"));
var _mytrack = _interopRequireDefault(require("./views/pages/mytrack"));
var _schedule = _interopRequireDefault(require("./views/pages/schedule"));
var _question = _interopRequireDefault(require("./views/pages/question1"));
var _question2 = _interopRequireDefault(require("./views/pages/question2"));
var _question3 = _interopRequireDefault(require("./views/pages/question3"));
var _question4 = _interopRequireDefault(require("./views/pages/question4"));
var _question5 = _interopRequireDefault(require("./views/pages/question5"));
var _welcomepage = _interopRequireDefault(require("./views/pages/welcomepage"));
var _exploretracks = _interopRequireDefault(require("./views/pages/exploretracks"));
var _exploretracks2 = _interopRequireDefault(require("./views/pages/exploretracks2"));
var _mytrack2 = _interopRequireDefault(require("./views/pages/mytrack2"));
var _mytrack3 = _interopRequireDefault(require("./views/pages/mytrack3"));
var _mytrack4 = _interopRequireDefault(require("./views/pages/mytrack4"));
var _schedule2 = _interopRequireDefault(require("./views/pages/schedule2"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// import views

// define routes
const routes = {
  '/': _welcomepage.default,
  '404': _.default,
  ...
  '/therapists': _therapists.default,
  '/therapists2': _therapists2.default,
  '/therapists3': _therapists3.default,
  '/therapists4': _therapists4.default,
  '/therapists5': _therapists5.default,
  '/therapists6': _therapists6.default,
  '/mytrack': _mytrack.default,
  '/mytrack2': _mytrack2.default,
  '/mytrack3': _mytrack3.default,
  '/mytrack4': _mytrack4.default,
  '/schedule': _schedule.default,
  '/schedule2': _schedule2.default,
  '/question1': _question.default,
  '/question2': _question2.default,
  '/question3': _question3.default,
  '/question4': _question4.default,
  '/question5': _question5.default,
  '/welcomepage': _home.default,
  '/exploretracks': _exploretracks.default,
  '/exploretracks2': _exploretracks2.default
};
class Router {
  constructor() {
    this.routes = routes;
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/therapists":"views/pages/therapists.js","./views/pages/therapists2":"views/pages/therapists2.js","./views/pages/therapists3":"views/pages/therapists3.js","./views/pages/therapists4":"views/pages/therapists4.js","./views/pages/therapists5":"views/pages/therapists5.js","./views/pages/therapists6":"views/pages/therapists6.js","./views/pages/mytrack":"views/pages/mytrack.js","./views/pages/schedule":"views/pages/schedule.js","./views/pages/question1":"views/pages/question1.js","./views/pages/question2":"views/pages/question2.js","./views/pages/question3":"views/pages/question3.js","./views/pages/question4":"views/pages/question4.js","./views/pages/question5":"views/pages/question5.js","./views/pages/welcomepage":"views/pages/welcomepage.js","./views/pages/exploretracks":"views/pages/exploretracks.js","./views/pages/exploretracks2":"views/pages/exploretracks2.js","./views/pages/mytrack2":"views/pages/mytrack2.js","./views/pages/mytrack3":"views/pages/mytrack3.js","./views/pages/mytrack4":"views/pages/mytrack4.js","./views/pages/schedule2":"views/pages/schedule2.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
},{"./../../dist/images/question_background_img.jpg":[["question_background_img.3f8e4d6b.jpg","../dist/images/question_background_img.jpg"],"../dist/images/question_background_img.jpg"],"./../../dist/images/home.jpg":[["home.81b8ee68.jpg","../dist/images/home.jpg"],"../dist/images/home.jpg"],"./../../dist/images/welcome.jpg":[["welcome.4c6f64a3.jpg","../dist/images/welcome.jpg"],"../dist/images/welcome.jpg"],"./../../dist/images/amazing.png":[["amazing.70bced93.png","../dist/images/amazing.png"],"../dist/images/amazing.png"],"./../../dist/images/dc1.jpg":[["dc1.dd1495a4.jpg","../dist/images/dc1.jpg"],"../dist/images/dc1.jpg"],"./../../dist/images/dc3.jpg":[["dc3.4e09c9f6.jpg","../dist/images/dc3.jpg"],"../dist/images/dc3.jpg"],"./../../dist/images/man.svg":[["man.0dca62f7.svg","../dist/images/man.svg"],"../dist/images/man.svg"],"./../../dist/images/dc4.jpg":[["dc4.b44a3c98.jpg","../dist/images/dc4.jpg"],"../dist/images/dc4.jpg"],"./../../dist/images/homepage.svg":[["homepage.7860ee9b.svg","../dist/images/homepage.svg"],"../dist/images/homepage.svg"],"./../../dist/images/girlhammock.png":[["girlhammock.f609ead9.png","../dist/images/girlhammock.png"],"../dist/images/girlhammock.png"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
